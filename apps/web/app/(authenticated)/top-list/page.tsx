...
import { useTopLists } from "../../../lib/use-lists";
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="line-clamp-1 text-xs text-muted-foreground">
                        {item.authors.length > 0 ? item.authors.join(", ") : t("unknownAuthor")}
                      </p>
                      <p className="line-clamp-1 text-xs text-muted-foreground">
                        {item.itemType === "audiobook" ? t("audiobook") : t("ebook")}
                      </p>
                    </div>
                    ...
                    <div className="shrink-0 text-right">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {sourceLabel} • {item.ratingsCount.toLocaleString()} {t("votes")}
                      </p>
                    </div>
                  </li>
                );
